...
`tinyTools` has been renamed as `tinytools`. So please uninstall it before you install `massqc`. **And don't use it any more.**
...
You can just use the `devtools` or `remotes` to install `massqc`. 
